...
// Cross Module References
	PMG_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
	PMG_API UClass* Z_Construct_UClass_AMyActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_PMG();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyActor_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_PMG,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyActor, 4143738533);
	template<> PMG_API UClass* StaticClass<AMyActor>()
	{
		return AMyActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/PMG"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
